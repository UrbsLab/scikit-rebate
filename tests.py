...
datasets = {
    "binary": pd.read_csv('data/GAMETES_Epistasis_2-Way_20atts_0.4H_EDM-1_1.csv').sample(frac=0.25),
    "cont_endpoint": pd.read_csv('data/GAMETES_Epistasis_2-Way_continuous_endpoint_a_20s_1600her_0.4__maf_0.2_EDM-2_01.csv').sample(frac=0.25),
    "mixed": pd.read_csv('data/GAMETES_Epistasis_2-Way_mixed_attribute_a_20s_1600her_0.4__maf_0.2_EDM-2_01.csv').sample(frac=0.25),
    "missing": pd.read_csv('data/GAMETES_Epistasis_2-Way_missing_values_0.1_a_20s_1600her_0.4__maf_0.2_EDM-2_01.csv').sample(frac=0.25),
    "multiclass": pd.read_csv('data/3Class_Datasets_Loc_2_01.csv').sample(frac=0.25)
}
...
def test_selector_on_dataset(cls, kwargs, dataset_name, genetic_data):
    ...
    assert 'M0P0' in selected_features or 'M0P1' in selected_features, (
