...
#     process_and_save_results(file_path, fs, "VLS_MultiSWRFDB")
# # *** MultiSWRFDB (for 500k feature set size: increasing num_feature_subset to 10,000)
# def process_vls_multiswrfdb(file_path):
...
#     process_and_save_results(file_path, fs, "VLS_MultiSWRFDBstar")
# # *** MultiSWRFDBstar (for 500k feature set size: increasing num_feature_subset to 10,000)
# def process_vls_multiswrfdbstar(file_path):
...
# *** MultiSWRFDBstar (for 500k feature set size). For TuRF part: 1 removal iteration, num_scores_to_return=100k. For VLS part: num_feature_subset=10000 instead of 400 now that features 100k -> 500k
def process_turf_vls_multiswrfdbstar_niter1_return100000(file_path):
    fs = TURF(relief_object=VLS(relief_object=MultiSWRFDBstar(n_jobs=1), num_feature_subset=10000, size_feature_subset=10000, random_state=42, n_jobs=-1), n_iterations=1, num_scores_to_return=100000)
    process_and_save_results(file_path, fs, "TURF_VLS_MultiSWRFDBstar_niter1_return100000")
...
def main():
    ...
    alg_map = {
        ...
        'turf_vls_multiswrfdb_niter1_return100000': process_turf_vls_multiswrfdb_niter1_return100000,
        'turf_vls_multiswrfdbstar_niter1_return100000': process_turf_vls_multiswrfdbstar_niter1_return100000,
