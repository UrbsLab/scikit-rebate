...
def process_results_dir(results_dir, prefix=""):
    ...
    rba_order = [
        ...
        'VLS_ReliefF10_paircoverage_subset5000',
        'VLS_MultiSWRFDB_paircoverage_subset5000',
        'VLS_MultiSWRFDBstar_paircoverage_subset5000',
        'TURF_VLS_ReliefF10_niter2_return10000',
        # 'TURF_VLS_MultiSWRFDB_niter2_return10000',
        # 'TURF_VLS_MultiSWRFDBstar_niter2_return10000',
        # 'TURF_VLS_MultiSWRFDB_niter1_return20000',
        # 'TURF_VLS_MultiSWRFDBstar_niter1_return20000',
        'TURF_VLS_MultiSWRFDB_niter1_return100000',
        'TURF_VLS_MultiSWRFDBstar_niter1_return100000',
        # 'Iter_ReliefF10',
        # 'Iter_MultiSWRFDB',
        # 'Iter_MultiSWRFDBstar',
    ]
    ...
    rba_descriptive_names = {
        ...
        'VLS_ReliefF10_paircoverage_subset5000': 'VLS (ReliefF 10NN, sub=5000), EPC',
        'VLS_MultiSWRFDB_paircoverage_subset5000': 'VLS (MultiSWRFDB, sub=5000), EPC',
        'VLS_MultiSWRFDBstar_paircoverage_subset5000': 'VLS (MultiSWRFDB*, sub=5000), EPC',
        ...
        # 'TURF_VLS_MultiSWRFDB_niter1_return20000': 'TuRF (VLS (MultiSWRFDB), n=1)',
        # 'TURF_VLS_MultiSWRFDBstar_niter1_return20000': 'TuRF (VLS (MultiSWRFDB*), n=1)',
        'TURF_VLS_MultiSWRFDB_niter1_return100000': 'TuRF (VLS (MultiSWRFDB), n=1)',
        'TURF_VLS_MultiSWRFDBstar_niter1_return100000': 'TuRF (VLS (MultiSWRFDB*), n=1)',
